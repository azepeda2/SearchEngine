...
public class BaseServlet extends HttpServlet {
	...
	protected void printUserName(PrintWriter out, HttpServletRequest request) {
		assert out != null;
		
		Map<String, String> cookies = getCookieMap(request);
		String user = cookies.get("name");
		
		out.println("\t<p align=\"right\">Current User: " + user + "<br>");
		out.println("\t<a href=\"/login?logout\">(logout)</a><br>");
		out.println("\t<a href=\"/account\">(account maintainance)</a><br>");
		out.println("\t<a href=\"/history\">(search history)</a></p>");
